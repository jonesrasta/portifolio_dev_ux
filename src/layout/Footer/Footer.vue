          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-6">
                          <a href="https://flowbite.com/" class="hover:underline">Skills</a>
                      </li>
                      <li>
                          <a href="https://tailwindcss.com/" class="hover:underline">Experience</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 sm:justify-center sm:mt-0 gap-x-4">
              <a href="https://www.linkedin.com/in/joneslima/" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" fill="#9E9E9E" width="20" height="20" viewBox="0 0 24 24"><path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/></svg>
                  <span class="sr-only">Facebook page</span>
              </a>
              <a href="https://github.com/jonesrasta" class="text-gray-500 hover:text-[#6FF1A6] dark:hover:text-white" target="_blank">

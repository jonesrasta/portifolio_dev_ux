    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 sm:justify-center sm:mt-0 gap-x-4">
              ...
              <a href="#" class="text-gray-500 hover:text-[#6FF1A6] dark:hover:text-white">
              ...
              <a href="#">
                <svg class="w-5 h-6 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 16">
